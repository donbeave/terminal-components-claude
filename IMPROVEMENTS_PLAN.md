...
Status: **research and planning complete; independent existing-Holla parity verification passed.**
Implementation is **not** part of this document's completion claim.
Scope: current `holla-fable` worktree, inspected 2026-09-10, plus the current
default branch of `tailrocks/holla` as the functional baseline. No other branch
or history of `terminal-components-claude` was consulted. Earlier library audit
findings and their evidence remain valid within their recorded scope.
...
These earlier library opportunities remain tracked. HP14/HP15 establish a concrete
Holla execution consumer for O01, and HP02/HP17/HP18 establish persisted-state
consumers; the application contracts are now required for parity. Generic shared
framework extraction remains conditional. None authorizes unrelated feature
...
- **C — Design-system/library work:** retained F01–F23 and conditional O01–O07.
...
**Dependencies:** HP15/HP16/HP17; F10–F15/F19/F20/F21/F23. O01 is no longer optional for a production executor, but a generic worker framework remains unapproved.
