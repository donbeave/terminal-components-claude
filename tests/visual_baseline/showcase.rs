...
crate::baseline_case!(showcase_pages_overview_default_80x24_truecolor => Case::new("showcase/pages/overview/80x24/truecolor", SHOWCASE, &["--page", "overview"], 80, 24, Color::Truecolor, BOOT));
crate::baseline_case!(showcase_pages_overview_default_80x24_none => Case::new("showcase/pages/overview/80x24/none", SHOWCASE, &["--page", "overview"], 80, 24, Color::None, BOOT));
...
crate::baseline_case!(showcase_pages_overview_default_120x40_none => Case::new("showcase/pages/overview/120x40/none", SHOWCASE, &["--page", "overview"], 120, 40, Color::None, BOOT));
crate::baseline_case!(showcase_pages_lists_default_80x24_truecolor => Case::new("showcase/pages/lists/80x24/truecolor", SHOWCASE, &["--page", "lists"], 80, 24, Color::Truecolor, BOOT));
crate::baseline_case!(showcase_pages_lists_default_80x24_none => Case::new("showcase/pages/lists/80x24/none", SHOWCASE, &["--page", "lists"], 80, 24, Color::None, BOOT));
...
crate::baseline_case!(showcase_pages_lists_default_120x40_none => Case::new("showcase/pages/lists/120x40/none", SHOWCASE, &["--page", "lists"], 120, 40, Color::None, BOOT));
crate::baseline_case!(showcase_pages_trees_default_80x24_truecolor => Case::new("showcase/pages/trees/80x24/truecolor", SHOWCASE, &["--page", "trees"], 80, 24, Color::Truecolor, BOOT));
crate::baseline_case!(showcase_pages_trees_default_80x24_none => Case::new("showcase/pages/trees/80x24/none", SHOWCASE, &["--page", "trees"], 80, 24, Color::None, BOOT));
...
crate::baseline_case!(showcase_pages_trees_default_120x40_none => Case::new("showcase/pages/trees/120x40/none", SHOWCASE, &["--page", "trees"], 120, 40, Color::None, BOOT));
crate::baseline_case!(showcase_pages_tables_default_80x24_truecolor => Case::new("showcase/pages/tables/80x24/truecolor", SHOWCASE, &["--page", "tables"], 80, 24, Color::Truecolor, BOOT));
crate::baseline_case!(showcase_pages_tables_default_80x24_none => Case::new("showcase/pages/tables/80x24/none", SHOWCASE, &["--page", "tables"], 80, 24, Color::None, BOOT));
...
crate::baseline_case!(showcase_pages_tables_default_120x40_none => Case::new("showcase/pages/tables/120x40/none", SHOWCASE, &["--page", "tables"], 120, 40, Color::None, BOOT));
crate::baseline_case!(showcase_pages_editable_default_80x24_truecolor => Case::new("showcase/pages/editable/80x24/truecolor", SHOWCASE, &["--page", "editabletables"], 80, 24, Color::Truecolor, BOOT));
crate::baseline_case!(showcase_pages_editable_default_80x24_none => Case::new("showcase/pages/editable/80x24/none", SHOWCASE, &["--page", "editabletables"], 80, 24, Color::None, BOOT));
...
crate::baseline_case!(showcase_pages_editable_default_120x40_none => Case::new("showcase/pages/editable/120x40/none", SHOWCASE, &["--page", "editabletables"], 120, 40, Color::None, BOOT));
crate::baseline_case!(showcase_pages_panels_default_80x24_truecolor => Case::new("showcase/pages/panels/80x24/truecolor", SHOWCASE, &["--page", "panels"], 80, 24, Color::Truecolor, BOOT));
crate::baseline_case!(showcase_pages_panels_default_80x24_none => Case::new("showcase/pages/panels/80x24/none", SHOWCASE, &["--page", "panels"], 80, 24, Color::None, BOOT));
...
crate::baseline_case!(showcase_pages_panels_default_120x40_none => Case::new("showcase/pages/panels/120x40/none", SHOWCASE, &["--page", "panels"], 120, 40, Color::None, BOOT));
crate::baseline_case!(showcase_pages_sidebars_default_80x24_truecolor => Case::new("showcase/pages/sidebars/80x24/truecolor", SHOWCASE, &["--page", "sidebars"], 80, 24, Color::Truecolor, BOOT));
crate::baseline_case!(showcase_pages_sidebars_default_80x24_none => Case::new("showcase/pages/sidebars/80x24/none", SHOWCASE, &["--page", "sidebars"], 80, 24, Color::None, BOOT));
...
crate::baseline_case!(showcase_pages_sidebars_default_120x40_none => Case::new("showcase/pages/sidebars/120x40/none", SHOWCASE, &["--page", "sidebars"], 120, 40, Color::None, BOOT));
crate::baseline_case!(showcase_pages_dialogs_default_80x24_truecolor => Case::new("showcase/pages/dialogs/80x24/truecolor", SHOWCASE, &["--page", "dialogs"], 80, 24, Color::Truecolor, BOOT));
crate::baseline_case!(showcase_pages_dialogs_default_80x24_none => Case::new("showcase/pages/dialogs/80x24/none", SHOWCASE, &["--page", "dialogs"], 80, 24, Color::None, BOOT));
...
crate::baseline_case!(showcase_pages_dialogs_default_120x40_none => Case::new("showcase/pages/dialogs/120x40/none", SHOWCASE, &["--page", "dialogs"], 120, 40, Color::None, BOOT));
crate::baseline_case!(showcase_pages_codeeditor_default_80x24_truecolor => Case::new("showcase/pages/codeeditor/80x24/truecolor", SHOWCASE, &["--page", "codeeditor"], 80, 24, Color::Truecolor, BOOT));
crate::baseline_case!(showcase_pages_codeeditor_default_80x24_none => Case::new("showcase/pages/codeeditor/80x24/none", SHOWCASE, &["--page", "codeeditor"], 80, 24, Color::None, BOOT));
...
crate::baseline_case!(showcase_pages_codeeditor_default_120x40_none => Case::new("showcase/pages/codeeditor/120x40/none", SHOWCASE, &["--page", "codeeditor"], 120, 40, Color::None, BOOT));
crate::baseline_case!(showcase_pages_datagrid_default_80x24_truecolor => Case::new("showcase/pages/datagrid/80x24/truecolor", SHOWCASE, &["--page", "datagrid"], 80, 24, Color::Truecolor, BOOT));
crate::baseline_case!(showcase_pages_datagrid_default_80x24_none => Case::new("showcase/pages/datagrid/80x24/none", SHOWCASE, &["--page", "datagrid"], 80, 24, Color::None, BOOT));
...
crate::baseline_case!(showcase_pages_datagrid_default_120x40_none => Case::new("showcase/pages/datagrid/120x40/none", SHOWCASE, &["--page", "datagrid"], 120, 40, Color::None, BOOT));
crate::baseline_case!(showcase_pages_chips_default_80x24_truecolor => Case::new("showcase/pages/chips/80x24/truecolor", SHOWCASE, &["--page", "chipsselects"], 80, 24, Color::Truecolor, BOOT));
crate::baseline_case!(showcase_pages_chips_default_80x24_none => Case::new("showcase/pages/chips/80x24/none", SHOWCASE, &["--page", "chipsselects"], 80, 24, Color::None, BOOT));
...
crate::baseline_case!(showcase_pages_chips_default_120x40_none => Case::new("showcase/pages/chips/120x40/none", SHOWCASE, &["--page", "chipsselects"], 120, 40, Color::None, BOOT));
crate::baseline_case!(showcase_pages_pickers_default_80x24_truecolor => Case::new("showcase/pages/pickers/80x24/truecolor", SHOWCASE, &["--page", "pickers"], 80, 24, Color::Truecolor, BOOT));
crate::baseline_case!(showcase_pages_pickers_default_80x24_none => Case::new("showcase/pages/pickers/80x24/none", SHOWCASE, &["--page", "pickers"], 80, 24, Color::None, BOOT));
...
crate::baseline_case!(showcase_pages_pickers_default_120x40_none => Case::new("showcase/pages/pickers/120x40/none", SHOWCASE, &["--page", "pickers"], 120, 40, Color::None, BOOT));
crate::baseline_case!(showcase_pages_chrome_default_80x24_truecolor => Case::new("showcase/pages/chrome/80x24/truecolor", SHOWCASE, &["--page", "chrome"], 80, 24, Color::Truecolor, BOOT));
crate::baseline_case!(showcase_pages_chrome_default_80x24_none => Case::new("showcase/pages/chrome/80x24/none", SHOWCASE, &["--page", "chrome"], 80, 24, Color::None, BOOT));
...
crate::baseline_case!(showcase_pages_chrome_default_120x40_none => Case::new("showcase/pages/chrome/120x40/none", SHOWCASE, &["--page", "chrome"], 120, 40, Color::None, BOOT));
crate::baseline_case!(showcase_pages_settings_default_80x24_truecolor => Case::new("showcase/pages/settings/80x24/truecolor", SHOWCASE, &["--page", "settings"], 80, 24, Color::Truecolor, BOOT));
crate::baseline_case!(showcase_pages_settings_default_80x24_none => Case::new("showcase/pages/settings/80x24/none", SHOWCASE, &["--page", "settings"], 80, 24, Color::None, BOOT));
...
crate::baseline_case!(showcase_pages_settings_default_120x40_none => Case::new("showcase/pages/settings/120x40/none", SHOWCASE, &["--page", "settings"], 120, 40, Color::None, BOOT));
crate::baseline_case!(showcase_pages_taskrunner_default_80x24_truecolor => Case::new("showcase/pages/taskrunner/80x24/truecolor", SHOWCASE, &["--page", "taskrunner"], 80, 24, Color::Truecolor, BOOT));
crate::baseline_case!(showcase_pages_taskrunner_default_80x24_none => Case::new("showcase/pages/taskrunner/80x24/none", SHOWCASE, &["--page", "taskrunner"], 80, 24, Color::None, BOOT));
...
crate::baseline_case!(showcase_pages_taskrunner_default_120x40_none => Case::new("showcase/pages/taskrunner/120x40/none", SHOWCASE, &["--page", "taskrunner"], 120, 40, Color::None, BOOT));
...
crate::baseline_case!(showcase_pages_scrolling_default_80x24_truecolor => Case::new("showcase/pages/scrolling/80x24/truecolor", SHOWCASE, &["--page", "scrolling"], 80, 24, Color::Truecolor, BOOT).sends(&["wait:739.63s"]).timeout(180000));
crate::baseline_case!(showcase_pages_scrolling_default_80x24_none => Case::new("showcase/pages/scrolling/80x24/none", SHOWCASE, &["--page", "scrolling"], 80, 24, Color::None, BOOT).sends(&["wait:739.63s"]).timeout(180000));
...
crate::baseline_case!(showcase_pages_scrolling_default_120x40_none => Case::new("showcase/pages/scrolling/120x40/none", SHOWCASE, &["--page", "scrolling"], 120, 40, Color::None, BOOT).sends(&["wait:739.63s"]).timeout(180000));
// `wait:7 of 7` is the step-rail end-state; 30s is tight under load.
crate::baseline_case!(showcase_pages_terminal_default_80x24_truecolor => Case::new("showcase/pages/terminal/80x24/truecolor", SHOWCASE, &["--page", "terminal"], 80, 24, Color::Truecolor, BOOT).sends(&["wait:7 of 7"]).timeout(60000));
crate::baseline_case!(showcase_pages_terminal_default_80x24_none => Case::new("showcase/pages/terminal/80x24/none", SHOWCASE, &["--page", "terminal"], 80, 24, Color::None, BOOT).sends(&["wait:7 of 7"]).timeout(60000));
...
crate::baseline_case!(showcase_pages_terminal_default_120x40_none => Case::new("showcase/pages/terminal/120x40/none", SHOWCASE, &["--page", "terminal"], 120, 40, Color::None, BOOT).sends(&["wait:7 of 7"]).timeout(60000));
crate::baseline_case!(showcase_pages_datagrid_default_120x40_256 => Case::new("showcase/pages/datagrid/120x40/256", SHOWCASE, &["--page", "datagrid"], 120, 40, Color::Ansi256, BOOT));
crate::baseline_case!(showcase_pages_datagrid_default_120x40_16 => Case::new("showcase/pages/datagrid/120x40/16", SHOWCASE, &["--page", "datagrid"], 120, 40, Color::Ansi16, BOOT));
crate::baseline_case!(showcase_pages_overview_default_120x40_nocolor => Case::new("showcase/pages/overview/120x40/nocolor", SHOWCASE, &["--page", "overview"], 120, 40, Color::NoColorEnv, BOOT));
crate::baseline_case!(showcase_pages_overview_default_72x20_truecolor => Case::new("showcase/pages/overview/72x20/truecolor", SHOWCASE, &["--page", "overview"], 72, 20, Color::Truecolor, BOOT));
...
crate::baseline_case!(showcase_flows_dialogs_destructive_120x40_truecolor => Case::new("showcase/flows/dialogs/destructive/120x40/truecolor", SHOWCASE, &["--page", "dialogs"], 120, 40, Color::Truecolor, BOOT).sends(&["tab", "tab", "tab", "tab", "enter", "wait:This cannot be undone"]));
...
crate::baseline_case!(showcase_flows_editor_completion_120x40_truecolor => Case::new("showcase/flows/editor/completion/120x40/truecolor", SHOWCASE, &["--page", "codeeditor"], 120, 40, Color::Truecolor, BOOT).sends(&["tab", "i", "type:cl", "wait: items"]));
...
crate::baseline_case!(showcase_flows_chips_select_open_120x40_truecolor => Case::new("showcase/flows/chips/select_open/120x40/truecolor", SHOWCASE, &["--page", "chipsselects"], 120, 40, Color::Truecolor, BOOT).sends(&["tab", "tab", "enter", "wait:customer"]));
...
crate::baseline_case!(showcase_pages_progress_default_80x24_truecolor => Case::new("showcase/pages/progress/80x24/truecolor", SHOWCASE, &["--page", "progress", "--motion", "paused"], 80, 24, Color::Truecolor, BOOT));
crate::baseline_case!(showcase_pages_progress_default_80x24_none => Case::new("showcase/pages/progress/80x24/none", SHOWCASE, &["--page", "progress", "--motion", "paused"], 80, 24, Color::None, BOOT));
...
crate::baseline_case!(showcase_pages_progress_default_120x40_none => Case::new("showcase/pages/progress/120x40/none", SHOWCASE, &["--page", "progress", "--motion", "paused"], 120, 40, Color::None, BOOT));
