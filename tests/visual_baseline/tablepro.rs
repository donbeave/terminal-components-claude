...
crate::baseline_case!(tablepro_query_results_120x40_truecolor => Case::new("tablepro/query/results/120x40/truecolor", TABLEPRO, &["--connect", "Production"], 120, 40, Color::Truecolor, "Query 1").sends(&["tab", "i", "type:SELECT * FROM ord", "enter", "type: WHERE st", "tab", "type: = 'pending' ORDER BY created_at DESC LIMIT 25", "escape", "sleep:200", "ctrl-r", "wait:25 rows", "wait:Ctrl+X Explain"]).timeout(15_000));
...
crate::baseline_case!(tablepro_query_close_confirm_120x40_truecolor => Case::new("tablepro/query/close_confirm/120x40/truecolor", TABLEPRO, &["--connect", "Production"], 120, 40, Color::Truecolor, "Query 1").sends(&["ctrl-t", "wait:Query 2", "sleep:200", "i", "type:x", "escape", "sleep:200", "ctrl-w", "wait:Close tab with unsaved work?"]));
crate::baseline_case!(tablepro_query_explain_analyze_120x40_truecolor => Case::new("tablepro/query/explain_analyze/120x40/truecolor", TABLEPRO, &["--connect", "Production"], 120, 40, Color::Truecolor, "Query 1").sends(&["tab", "i", "type:SELECT * FROM orders", "escape", "sleep:300", "alt-x", "wait:EXPLAIN ANALYZE"]).timeout(15_000));
...
// query first, then q.
crate::baseline_case!(tablepro_workbench_quit_confirm_120x40_truecolor => Case::new("tablepro/workbench/quit_confirm/120x40/truecolor", TABLEPRO, &["--connect", "Production"], 120, 40, Color::Truecolor, "Query 1").sends(&["tab", "i", "type:x", "escape", "sleep:200", "q", "wait:Quit TablePro?"]));
