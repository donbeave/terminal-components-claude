...
| API-4: DESIGN incorrectly denies existing context-menu/diff capability | Fixed | `docs/design/DESIGN.md:860` documents DiffView; L1285 now excludes only toast/generic badge. README links the audit and inventory and labels the reusable-library ideas as hypotheses. |
