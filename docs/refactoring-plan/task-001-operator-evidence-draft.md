...
> **Draft / historical:** Filled example from retired `.worktrees/main` @ `task-001-bootstrap`. Use [task-001-operator-evidence-template.md](task-001-operator-evidence-template.md) for live Phase 4 on `.worktrees/campaign`.
