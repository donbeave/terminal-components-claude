...
**Path layout:** [`path-contract.md`](path-contract.md) (canonical container vs host paths). TASK-001: [`task-001-verify-container.md`](task-001-verify-container.md). TASK-002+: [`task-production-verify-container.md`](task-production-verify-container.md).
