...
**Branch:** `prep-wave1-verify` (planning); execution worktree `.worktrees/campaign` on `refactor/holla-parity`  
...
From the campaign worktree root (`.worktrees/campaign`), this resolves to a sibling checkout:
