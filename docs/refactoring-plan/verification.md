...
`git ls-remote https://github.com/donbeave/tui-snap.git refs/heads/main` returned `0a2e490802b7b048cd96349c6af860f8a3a05c3d` (verified 2026-09-15). The independently reviewed repair lineage begins at upstream `5036cf87…`, continues through merged [PR #1](https://github.com/donbeave/tui-snap/pull/1) head `883d03f19d890bbbf27468798db78b04e85297ac`, and the campaign pins the current main tip `0a2e490…` which adds tiered grouped checks, PTY input pacing, and fast PNG compare on top of that reviewed merge. The crate name is `tuisnap`, version 0.2.0. Its Ratatui dependency is 0.30, matching the oracle's Ratatui generation. Main uses `ratatui-core` 0.1.2; the external verification harness may depend on Ratatui 0.30 but must not reintroduce that facade into the backend-free production crate.
...
Required tool dependency is [tui-snap](https://github.com/donbeave/tui-snap), campaign-pinned at `0a2e490802b7b048cd96349c6af860f8a3a05c3d` (`Cargo.toml` git rev). This commit includes the merged [PR #1](https://github.com/donbeave/tui-snap/pull/1) reviewed head `883d03f19d890bbbf27468798db78b04e85297ac` (tree `dadbaa70facc317cfabb52f0374c1f3cdceb46a1`) plus subsequent grouped-store, render, and performance gates used by visual-baseline CI smoke. Do not follow an unpinned branch; refreeze the catalog when the pin changes. Historical qualification evidence for the reviewed merge remains in [tuisnap-assessment.md](evidence/tuisnap-assessment.md) and [tuisnap-review.md](tuisnap-review.md).
