...
```json
{
  ...
  "evidence_fields": [
    ...
    {"id": "EV-002", "name": "architecture_source_commit", "required": true, "binds": "campaign worktree (.worktrees/campaign) HEAD on refactor/holla-parity at dispatch"},
    ...
    {"id": "EV-005", "name": "taskfmt_revision", "required": true, "binds": "afd3b575dbcc7044620bec4b9493a74eca3e5ef2"},
    {"id": "EV-006", "name": "taskfmt_version", "required": true, "binds": "exact taskfmt --version output"},
    {"id": "EV-007", "name": "taskfmt_sha256", "required": true, "binds": "installed taskfmt executable bytes"},
  ...
  "checklist_steps": [
    ...
    {"id": "OB-002", "action": "Create or verify .worktrees/campaign on refactor/holla-parity via campaign-init.sh; record HEAD.", "evidence": ["EV-002"], "sign_off": "SO-002"},
    {"id": "OB-003", "action": "Verify pinned catalog, bootstrap package, and taskfmt revision/version/executable hash.", "evidence": ["EV-003", "EV-004", "EV-005", "EV-006", "EV-007"], "sign_off": "SO-003"},
