...
| `app_tests::editor_env_plain_value_stays_masked_and_can_be_shown` | a plain env value stays masked until explicitly revealed | **MIGRATES IN SLICE 7** — same; §16.4 adds `jackin::form_dialog_secret_never_reaches_the_screen_as_a_string` |
