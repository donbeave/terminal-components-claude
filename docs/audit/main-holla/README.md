# Main/Holla investigation evidence

These reports are source audits and measured baseline evidence at pinned main
`c12cad8728755cd2d03eefdd8e02891143fca86d` and Holla
`794b095c196562d38f1b6f7ce379c128af2a023d`. They are not completion approvals.
The execution authority is `docs/plans/main-holla-integration-task.md`; the
resumable work order is `docs/plans/main-holla-integration.md`.
...
defects require narrow tested corrections rather than reproduction.
