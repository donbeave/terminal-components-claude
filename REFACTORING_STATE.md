...
- opus-analyst (running): docs/reviews/slice3-foundations-review.md — API review of real foundation surface + adjudication of 8 research requests (crossterm feature scope; Id structural equality; Ansi16 metric CIE76 vs legacy luma; fit alloc threshold; smallvec via crossterm closure; intents-drain ratio; Track::Auto; style-resolve per-query bound) + 12 deviations + §24.4 self-declared names.
