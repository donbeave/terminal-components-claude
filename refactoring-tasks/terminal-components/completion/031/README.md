...
- `/task/trusted/branch-host-projection.tsv`: CHK-006 branch witness membership index; every listed witness_id must resolve to an accepted producer receipt before TASK-031 dispatch.
...
- **D-008:** CHK-006 required-set membership includes branch witnesses listed in `/task/trusted/branch-host-projection.tsv` by reference to accepted TASK-021–028 receipts. Application witness W-042-JUMP-SUBMIT is excluded; TASK-042 owns it after TASK-041.
