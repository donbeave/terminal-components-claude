...
- `trusted/branch-host-projection.tsv`: CHK-006 branch witness membership index; every listed witness_id must resolve to an accepted producer receipt before TASK-031 dispatch.
