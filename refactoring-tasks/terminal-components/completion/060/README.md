...
schema: task/v5
id: TASK-060
title: "Restore TablePro grid filters and structure surfaces"
kind: bugfix
---

# TASK-060 — Restore TablePro grid filters and structure surfaces
...
- **D-001:** Replace decorative legacy filter painting and inverted Data/Structure label selection with actual controlled components that paint the same state dispatch updates.
