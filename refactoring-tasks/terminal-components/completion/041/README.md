...
schema: task/v5
id: TASK-041
title: "Restore Holla finder discovery query and preview"
kind: refactor
---

# TASK-041 — Restore Holla finder discovery query and preview
...
Grouped finder/discovery, typed query/scopes, split/drawer previews, alternatives/pin/alias/hide and usage worlds match oracle. The application report shows that a migrated file, a green self-baseline or a generic component call can coexist with wrong live behavior. This task proves actual public-component state transitions and oracle output, not nominal API use.
...
- **P-001:** Accepted receipts for `terminal-components/completion/040`, `terminal-components/completion/024`, `terminal-components/completion/021` exist, their accepted source commits are ancestors of the integrated parent, and the whole sealed baseline/test-disposition products are present.
...
- Restore adaptive grouped discovery and diagnostics, stable source/action identity, scope axis/tokens, typing-hot query/undo/redo/paste, persisted usage/recents and failure/no-history behavior; exact preview command/type/scope/reason, summary/drawer versus split at body width108; alternatives/pin/alias/hide/why. Preserve modifier guard ordering, query-before-scope Escape, navigation/preview scroll and unfaded cursor rows.
- Exact complete primary IDs: `APP:HO-BASE-01`, `APP:HO-BASE-02`, `APP:HO-BASE-03`, `APP:HO-BASE-04`, `APP:HO-BASE-11`, `APP:HO-BASE-12`, `APP:HO-BASE-13`, `APP:HO-ROUTE-06`, `APP:HO-ROUTE-10`, `APP:HO-ROUTE-14`, `APP:HO-ROUTE-16`, `APP:HO-ROUTE-19`, `APP:HO-SHELL`, `APP:HO-FINDER-EMPTY`, `APP:HO-FINDER-EDIT`.
...
- **R-001 (MUST):** Restore adaptive grouped discovery and diagnostics, stable source/action identity, scope axis/tokens, typing-hot query/undo/redo/paste, persisted usage/recents and failure/no-history behavior; exact preview command/type/scope/reason, summary/drawer versus split at body width108; alternatives/pin/alias/hide/why. Preserve modifier guard ordering, query-before-scope Escape, navigation/preview scroll and unfaded cursor rows. Complete parent scenarios are exactly those in `trusted/scenario-ids.tsv`. Required early contributions are exactly the nonempty protected rows in `trusted/stage-contributions.tsv`; frame contributions compare complete selected checkpoints under AC-001/CHK-004, while semantic contributions are independently checked under AC-008/CHK-006. A contribution never closes its parent. Full parent transcripts execute diagnostically until their recorded complete owner, and every prior closed contribution remains required. `trusted/holla-route-expansion.md` requires unchanged native assertions at native source dimensions plus separately mapped oracle-derived size captures; no assertion deletion, candidate coordinate selection, masks or fabricated whole-parent pass. B-HO-07 in trusted/holla-branch-corrections.md requires alias-transfer-exact, alias-case-sensitive-ownership and ranking-reset-all-paths under HO-ROUTE-10. Transfer exact-string aliases; reset every learned/hidden entry for the item while keeping pins and aliases. Native fixture setup is not CLI reachability evidence.
- **R-002 (MUST):** Shared TextInput/edit core, keyed collection, TextViewport, Panel and runtime menus own input and appearance. No duplicated finder editor, selection or fades. Holla owns ranking/catalog/usage and simulated persistence; no real discovery or home-data writes. Keep typed identities and encapsulated app ranking, not main's oracle-conflicting lowercase NameOwned rejection or reset_at policy. Shared configured TextInput/Dialog/Menu own the alias editor and focus; no application-local editor.
...
- **D-001:** Shared TextInput/edit core, keyed collection, TextViewport, Panel and runtime menus own input and appearance. No duplicated finder editor, selection or fades. Holla owns ranking/catalog/usage and simulated persistence; no real discovery or home-data writes.
