...
- **D-001:** World owns running work across navigation; TextViewport/editor core, ChipBar, Picker/Dialog and runtime own interaction mechanics. Preserve incremental append rather than rebuilding retained output; cancellation is domain progress, not disappearance of a page. Use virtual Clock and finite coordinator outcomes only.
