...
schema: task/v5
id: TASK-059
title: "Restore TablePro explorer tabs and responsive workbench"
kind: bugfix
---

# TASK-059 — Restore TablePro explorer tabs and responsive workbench

## Goal

Restore Workbench focus cycle, lazy Explorer/filter/refresh/schema actions, keyboard opening and pointer preview/promotion, tab navigation/overflow/empty state, drawer/hide/maximize and resize recovery.
...
- **P-001:** TASK-058, TASK-024 have accepted protected receipts and their actual commits are ancestors of the integrated parent; the host has reconstructed a fresh exact scope base containing their outputs.
...
- **D-001:** Preserve the body-width 100/terminal-width 102 drawer boundary with both 101 and 102 probes, including oracle zero-area focus stops; do not substitute a permanently visible splitter.
- **D-002:** A single click reuses preview and a second same-object click promotes it; pinned tabs retain identity and state across later previews.
- **D-003:** Every owned command must reach an update handler and live rendered control. Declarations or synthetic set_surface snapshots cannot prove command reachability.
