...
- **R-002 (MUST):** Preserve frozen original archives and accepted oracle replacements separately. Moving an assertion never changes its meaning. Preserve primary-toolchain compile-fail assertions and the existing MSRV profile assignment; test counts and cargo listings are not execution proof.
