...
pub(crate) const TASKS: &[TaskRow] = &[
    ...
    TaskRow {
        id: 1041,
        name: "Migrate sessions table to UUID keys",
        owner: "jonas",
        status: TaskStatus::Running,
        branch: "chore/uuid-sessions",
        changes: 31,
        duration_s: 96,
    },
    TaskRow {
        id: 1042,
        name: "Fix flaky checkout integration test",
        owner: "ana",
    ...
    TaskRow {
        id: 1043,
        name: "Write release notes for 3.2",
        owner: "mira",
        status: TaskStatus::Queued,
        branch: "docs/release-3.2",
        changes: 0,
        duration_s: 0,
    },
    TaskRow {
        id: 1044,
        name: "Replace deprecated Vue mixins",
        owner: "kai",
        status: TaskStatus::Done,
        branch: "refactor/mixins",
        changes: 87,
        duration_s: 1330,
    },
    TaskRow {
        id: 1045,
        name: "Upgrade Postgres driver to 0.9",
        owner: "jonas",
        status: TaskStatus::Paused,
        branch: "chore/pg-driver",
        changes: 5,
        duration_s: 240,
    },
    TaskRow {
        id: 1046,
        name: "Extract billing service module",
        owner: "sofia",
        status: TaskStatus::Done,
        branch: "refactor/billing",
        changes: 52,
        duration_s: 908,
    },
    TaskRow {
        id: 1047,
        name: "Add OpenTelemetry tracing spans",
        owner: "kai",
        status: TaskStatus::Running,
        branch: "feat/otel",
        changes: 22,
    ...
    TaskRow {
        id: 1048,
        name: "Remove legacy feature flags",
        owner: "ana",
        status: TaskStatus::Queued,
        branch: "chore/flags",
        changes: 0,
    ...
    TaskRow {
        id: 1051,
        name: "Speed up cold start of worker",
        owner: "jonas",
        status: TaskStatus::Failed,
        branch: "perf/worker-boot",
        changes: 9,
        duration_s: 601,
    },
    TaskRow {
        id: 1052,
        name: "Localize onboarding emails",
        owner: "kai",
        status: TaskStatus::Queued,
        branch: "feat/i18n-emails",
        changes: 0,
        duration_s: 0,
    },
    TaskRow {
        id: 1053,
        name: "Add pagination to audit log",
        owner: "ana",
        status: TaskStatus::Done,
        branch: "feat/audit-pages",
        changes: 16,
        duration_s: 344,
    },
    TaskRow {
        id: 1054,
        name: "Refactor retry helper into crate",
        owner: "sofia",
        status: TaskStatus::Running,
    ...
    TaskRow {
        id: 1055,
        name: "Rotate signing keys quarterly",
        owner: "mira",
        status: TaskStatus::Queued,
        branch: "sec/key-rotation",
        changes: 0,
        duration_s: 0,
    },
    TaskRow {
        ...
        owner: "jonas",
        status: TaskStatus::Done,
        branch: "fix/tz-scheduler",
        changes: 7,
        duration_s: 188,
    },
    TaskRow {
        id: 1057,
        name: "Document webhook retry semantics",
        owner: "kai",
        status: TaskStatus::Done,
    ...
    TaskRow {
        id: 1058,
        name: "Add dark mode to admin panel",
        owner: "ana",
        status: TaskStatus::Paused,
        branch: "feat/admin-dark",
        changes: 40,
        duration_s: 720,
    },
    TaskRow {
        id: 1059,
        name: "Bump minimum Node to 22",
        owner: "sofia",
        status: TaskStatus::Queued,
    ...
    TaskRow {
        id: 1060,
        name: "Cache dependency graph between runs",
        owner: "mira",
        status: TaskStatus::Running,
        branch: "perf/dep-cache",
        changes: 19,
        duration_s: 210,
    },
    TaskRow {
        id: 1061,
        name: "Clean up unused SQL views",
        owner: "jonas",
        status: TaskStatus::Done,
        branch: "chore/sql-views",
        changes: 12,
        duration_s: 155,
    },
    TaskRow {
        id: 1062,
        name: "Add health endpoint for gateway",
        owner: "kai",
        status: TaskStatus::Done,
        branch: "feat/health",
        changes: 3,
    ...
    TaskRow {
        id: 1063,
        name: "Investigate memory growth in parser",
        owner: "ana",
        status: TaskStatus::Running,
        branch: "perf/parser-mem",
        changes: 6,
        duration_s: 380,
    },
];
...
pub(crate) const SCROLL_ROWS: &[&str] = &[
    "Row 001", "Row 002", "Row 003", "Row 004", "Row 005", "Row 006", "Row 007", "Row 008",
    "Row 009", "Row 010", "Row 011", "Row 012", "Row 013", "Row 014", "Row 015", "Row 016",
    "Row 017", "Row 018", "Row 019", "Row 020", "Row 021", "Row 022", "Row 023", "Row 024",
    "Row 025", "Row 026", "Row 027", "Row 028", "Row 029", "Row 030", "Row 031", "Row 032",
    "Row 033", "Row 034", "Row 035", "Row 036", "Row 037", "Row 038", "Row 039", "Row 040",
    "Row 041", "Row 042", "Row 043", "Row 044", "Row 045", "Row 046", "Row 047", "Row 048",
    "Row 049", "Row 050", "Row 051", "Row 052", "Row 053", "Row 054", "Row 055", "Row 056",
    "Row 057", "Row 058", "Row 059", "Row 060", "Row 061", "Row 062", "Row 063", "Row 064",
    "Row 065", "Row 066", "Row 067", "Row 068", "Row 069", "Row 070", "Row 071", "Row 072",
    "Row 073", "Row 074", "Row 075", "Row 076", "Row 077", "Row 078", "Row 079", "Row 080",
    "Row 081", "Row 082", "Row 083", "Row 084", "Row 085", "Row 086", "Row 087", "Row 088",
    "Row 089", "Row 090", "Row 091", "Row 092", "Row 093", "Row 094", "Row 095", "Row 096",
    "Row 097", "Row 098", "Row 099", "Row 100", "Row 101", "Row 102", "Row 103", "Row 104",
